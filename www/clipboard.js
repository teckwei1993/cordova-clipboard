 ...
 * @param {Function} onFail    The function to call in case of error
 */
Clipboard.prototype.hasUrls = function (onSuccess, onFail) {
    cordova.exec(onSuccess, onFail, "Clipboard", "hasUrls", []);
};
 ...
 * @param {Function} onFail    The function to call in case of error
 */
Clipboard.prototype.contain = function (text, onSuccess, onFail) {
    if (typeof text === "undefined" || text === null) text = "";
    cordova.exec(onSuccess, onFail, "Clipboard", "contain", [text]);
};
